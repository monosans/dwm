...
static const char col_blue1[]       = "#282c34";
static const char col_blue2[]       = "#528bff";
static const char col_white[]       = "#abb2bf";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_white, col_blue1, col_blue1 },
	[SchemeSel]  = { col_blue1, col_blue2, col_blue2 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_blue1, "-nf", col_white, "-sb", col_blue2, "-sf", col_blue1, NULL };
